...
class RoutingTests(APITestCase, URLPatternsTestCase):
    urlpatterns = [path("api/", include("traveller.urls"))]

    def test_travelling_salesman_routing_solutions(self):
    ...
    def test_vehicle_routing_solution(self):
        url = reverse("route")
        response = self.client.get(
            url,
            format="json",
    ...
    def test_time_window_constraint_solution(self):
